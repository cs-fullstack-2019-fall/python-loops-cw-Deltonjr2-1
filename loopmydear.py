# Test x= input("What is your name ")
...
#1 for idx in range 50, x<-20, -1 for  item in range (50 -20 -1) -1 because you are counting down

# for item in range (50,-20, -1):
#     print(item)

# 2.    Create a loop that prints even numbers from 0 to and including 20
